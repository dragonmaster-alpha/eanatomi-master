! function() {
  function CustomStyle() {
    this.selectors = ["#livechat-badge", "#livechat-full", "#livechat-compact-container", "#livechat-eye-catcher", "#livechat-compact-view"], this.parseMobileCss = function(e, t) {
      ...
      var i = function(e, t) {
          t = t || 0;
          var n, o, a, s;
          return n = e.indexOf("}", t), -1 === n ? !1 : (o = e.substr(0, n + 1), a = o.match(/{/g) && o.match(/{/g).length || 0, s = o.match(/}/g) && o.match(/}/g).length || 0, a !== s ? i(e, o.length) : o = o.substr(o.indexOf("{") + 1, o.lastIndexOf("}") - o.indexOf("{") - 1))
        },
        n = -1;
      return n = e.indexOf("@livechat-mobile"), -1 === n ? !1 : (e = e.substr(n, e.length + 1 - n), cuttedCustomStyle = i(e), cuttedCustomStyle)
      ...
      if ("string" == typeof e && (e = document.getElementById(e)), e || e instanceof HTMLElement) {
        ...
        if ("[object Object]" === Object.prototype.toString.call(t))
          for (var a in t) n ? e.style[o](a, t[a]) : e.style[o](a, t[a], "important");
        else {
      ...
      try {
        ...
        for (var i, n, o, a = -1, s = -1, r = 0; r < this.selectors.length; r++) i = e.indexOf(this.selectors[r]), n = e.lastIndexOf(this.selectors[r]), -1 !== i && (-1 === a || a > i) && (a = i), -1 !== n && n > s && (s = n);
        if (o = e.indexOf("}", s), -1 === o && (o = e.length), -1 === a) return !1;
        e = e.substr(a, o + 1 - a);
        var l = /{([^}]*)}/gm,
          c = e.replace(l, "$%^");
        ...
        for (var d = c.split("$%^"), u = "", _ = "", h = "", m = "", f = 0; f < d.length; f++) {
          u = d[f];
          for (var p = 0; p < this.selectors.length; p++)
            if (-1 !== u.indexOf(this.selectors[p]) && (_ = e.substr(e.indexOf(u), e.length + 1), _.length > 1)) {
              h = u.split(",");
              for (var g = 0; g < h.length; g++) - 1 !== h[g].indexOf(this.selectors[p]) && (_ = _.replace(/(\r\n|\n|\r)/gm, "").match(/{(.*?)}/)[0], m = m + h[g] + _)
            }
        }
        if ("" !== m) {
          if (-1 !== m.indexOf("transform")) {
            for (var b = m.split(";"), r = 0; r < b.length; r++) - 1 !== b[r].indexOf("transform") && -1 === b[r].indexOf("text-transform") && (b[r] = b[r] + "!important");
            m = b.join(";")
          }
  ...
  function LiveChat(config) {
    this.lang_sent_phrases = null, this.embedded_chat_hidden_by_api = !1, this.invoked_callbacks = {}, this.is_main_window = !1, this.EMBEDDED_LOADED = 0, this.httpp = -1 != window.location.protocol.indexOf("https") ? "https://" : "http://", this.location = encodeURIComponent(document.location), this.INVITATION_NONE = 0, this.INVITATION_STANDARD = 1, this.INVITATION_AUTO = 2, this.INVITATION_PERSONAL = 3, this.current_invitation = this.INVITATION_NONE, this.$invitation_layer = !1, this.$invitation_image = !1, this.$overlay = !1, this.conf = config, this.invitation_layer_id = "lc_invite_layer", this.private_invite_script_id = "LC_Private_Invite", this.auto_invite_script_id = "LC_Auto_Invite", this.invite_layer = "lc_invite_layer", this.is_popped_out = !1, this.destinationSkillChosen = null, this.msie = /msie/i.test(navigator.userAgent) && !/opera/i.test(navigator.userAgent), this.msie_version = this.msie ? function() {
      ...
      var e = -1 !== Utils.inArray(__lc.license, [6514781, 100000334, 100000006, 7188861, 6463811]);
      ...
      var t, i, e = e || location.hostname,
        n = this.conf.domain_whitelist;
      if (0 === n.length) return !0;
      for (e = e.toLowerCase(), "." === e[e.length - 1] && (e = e.slice(0, -1)), n.push("livechatinc.com"), t = 0; t < n.length; t++)
        if (i = n[t], -1 !== e.indexOf(i, e.length - i.length) && (e.length === i.length || "." === e.charAt(e.length - i.length - 1))) return !0;
      ...
      return LC_API.embedded_chat_enabled() === !1 ? !1 : (null == e && (e = this.lang_sent_phrases), NotifyChild.send("language_phrases;" + JSON.stringify(e)), void(this.lang_sent_phrases = e))
      ...
      return "string" != typeof __lc_params ? !0 : 0 == __lc_params.length ? !0 : void this.set_custom_variables(__lc_params)
    }, this.embedded_chat_enabled = function() {
      return __lc_settings.embedded.enabled
    }, this.embedded_hide_when_offline = function() {
      return this.destinationSkillChosen === !0 ? !1 : !this.getVisitorInteraction() && __lc_settings.embedded.hide_when_offline
      ...
      if (document.querySelectorAll) {
        ...
        for (availableButtons = LC_Invite.conf.buttons, len2 = availableButtons.length, DOMButtons = document.querySelectorAll(".livechat_button"), i = 0, len = DOMButtons.length; len > i; i++)
          if (DOMButton = DOMButtons[i], DOMButtonID = DOMButton.getAttribute("data-id"), text = DOMButton.innerText || DOMButton.textContent, url = "", DOMButton.children[0] && DOMButton.children[0].href && (url = DOMButton.children[0].href), DOMButtonID)
            for (j = 0; len2 > j; j++) button = availableButtons[j], button.id === DOMButtonID && ("image" === button.type ? DOM.innerHTML(DOMButton, '<a href="' + url + '" onclick="LC_API.open_chat_window();return false;"><img src="//' + button.value + '" alt="' + text + '" title="' + text + '"></a>') : "text" === button.type && DOM.innerHTML(DOMButton, '<a href="" onclick="LC_API.open_chat_window();return false;">' + button.value + "</a>"))
      }
      if ("undefined" == typeof __lc_buttons) {
        var self = this,
          wait_for_lc_buttons_counter = 0,
          wait_for_lc_buttons = function() {
            return wait_for_lc_buttons_counter++, wait_for_lc_buttons_counter > 20 ? !0 : "undefined" != typeof __lc_buttons ? (self.display_chat_buttons(), !0) : void setTimeout(function() {
              wait_for_lc_buttons()
            }, 500)
          };
        wait_for_lc_buttons()
      ...
      var t;
      return t = CustomVariablesParser.parse(e), t === !1 ? !1 : (this.conf.lc.params = t, NotifyChild.send("params;" + encodeURIComponent(this.conf.lc.params)), void Pinger.set_force_reload(!0).ping())
    }, this.check_if_invitation_allowed = function(e) {
      return LC_API.chat_window_maximized() === !0 ? !1 : e > this.current_invitation || e == this.current_invitation && e != this.INVITATION_STANDARD
    }, this.load_standard_invitation = function() {
      var e;
      return LC_API.embedded_chat_enabled() === !0 ? this.chat_ended ? (function(e, t) {
        t = t || {}, "undefined" != typeof e ? NotifyChild.send("start_chat;" + encodeURIComponent(e)) : NotifyChild.send("start_chat"), Mobile.isDetected() !== !1 || t.ignoreOpening || LC_API.open_chat_window()
      }(e, {
        ignoreOpening: !0
      }), !0) : (LC_API.start_chat(), !0) : 0 == this.check_if_invitation_allowed(this.INVITATION_STANDARD) ? !1 : (this.current_invitation = this.INVITATION_STANDARD, AnalyticsIntegrations.trackPageView("Standard greeting", {
        nonInteraction: !0,
        onlyMainWindow: !1
      }), void this.display_invitation(this.standard_invite_html, this.conf.position))
    }, this.load_personal_invitation = function(e) {
      if (LC_API.embedded_chat_enabled() === !0) this.current_invitation = this.INVITATION_PERSONAL;
      else {
      ...
      return 0 == this.check_if_invitation_allowed(this.INVITATION_AUTO) ? !1 : (this.current_invitation = this.INVITATION_AUTO, void this.trackAndRenderAutoInvitation(e, {
        maximizeWindow: !0
      }))
      ...
      var i = document,
        n = (i.documentElement, i.getElementById ? i.getElementById(e) : i.all ? i.all[e] : i.layers[e]),
      ...
      var i, n;
      this.lc_popup_hide(), "undefined" == typeof e ? (NotifyChild.send("source_invitation"), e = "") : NotifyChild.send("source_invitation;" + encodeURIComponent(e)), "undefined" == typeof t && (t = this.conf.lc.groups), LC_API.embedded_chat_supported() && LC_API.embedded_chat_enabled() ? LC_API.show_full_view() : (n = {
        groups: t,
        timestamp: +new Date,
        trigger: e
      ...
      if ("undefined" != typeof LC_AutoInvite && LC_API.embedded_chat_enabled() === !0) {
        var i, o, a, s;
        return i = e.match(/lc_open_chat\('(.*?)', (.*?)\)/), o = i[1], a = i[2], "function" == typeof LC_AutoInvite.get_invitation_content ? s = LC_AutoInvite.get_invitation_content() : "function" == typeof LC_AutoInvite.construct_invite ? (s = LC_AutoInvite.construct_invite(), s = s.match(/div_greeting-message">(.*?)<\/div>/)[1] ? s.match(/div_greeting-message">(.*?)<\/div>/)[1] : "") : s = "", LC_API.display_embedded_invitation(s, o, a), !0
      }
      this.lc_popup_hide(), this.conf.overlay.enabled = Boolean("centered" == t.option), this.$invitation_layer.innerHTML = e;
      var r;
      this.current_invitation == this.INVITATION_STANDARD ? r = "lc_standard_invitation_img" : this.current_invitation == this.INVITATION_PERSONAL ? r = "lc_personal_invitation_img" : this.current_invitation == this.INVITATION_AUTO && (r = "lc_auto_invitation_img"), this.$invitation_image = $(r), this.show_invitation_layer(this.invitation_layer_id, t)
      ...
      e(0);
      var t = 0,
        i = parseInt(100 * this.conf.overlay.opacity),
        n = Math.abs((i - t) / 5),
        o = 1,
        a = function(o) {
      ...
      if (e = document.getElementsByTagName("body")[0], n = document.createElement("div"), n.setAttribute("id", "livechat-full"), t = n.style, t.position = "fixed", t.bottom = "0", t.right = this.conf.embedded.dimensions.margin + "px", t.width = this.conf.embedded.dimensions.width + "px", t.height = this.conf.embedded.dimensions.height + "px", t.overflow = "hidden", t.visibility = "hidden", t.zIndex = "-1", t.background = "transparent", t.border = "0", t.transition = "transform .2s ease-in-out", t.WebkitTransition = "transform .2s ease-in-out", t.MozTransition = "transform .2s ease-in-out", t.OTransition = "transform .2s ease-in-out", t.MsTransition = "transform .2s ease-in-out", Mobile.isDetected() === !1 && (t.webkitBackfaceVisibility = "hidden"), LC_API.mobile_is_detected() && !LC_API.new_mobile_is_detected() && (t.position = "absolute", t.top = "-9999em", t.left = "-9999em", t.bottom = "auto", t.right = "auto"), LC_API.new_mobile_is_detected() && (t.zIndex = "-1"), a = document.createElement("iframe"), a.setAttribute("src", __lc_iframe_src_hash), a.setAttribute("id", "livechat-full-view"), a.setAttribute("name", "livechat-full-view"), a.setAttribute("scrolling", "no"), a.setAttribute("frameborder", "0"), a.setAttribute("allowtransparency", "true"), s = a.style, s.position = "absolute", s.top = "0", s.right = "0", s.bottom = "0", s.left = "0", s.width = "100%", s.height = "100%", s.border = "0", s.padding = "0", s.margin = "0", s["float"] = "none", s.background = "none", a.onload = LC_Invite.iframe_full_view_loaded, n.appendChild(a), o = document.createElement("div"), o.setAttribute("id", "livechat-compact-container"), i = o.style, i.position = "fixed", i.bottom = "0", i.right = this.conf.embedded.dimensions.margin + "px", i.width = this.conf.embedded.dimensions.width_minimized + "px", i.height = "53px", i.overflow = "hidden", i.visibility = "hidden", i.zIndex = "2147483639", i.background = "transparent", i.border = "0", i.transition = "transform .2s ease-in-out", i.WebkitTransition = "transform .2s ease-in-out", i.MozTransition = "transform .2s ease-in-out", i.OTransition = "transform .2s ease-in-out", i.MsTransition = "transform .2s ease-in-out", Mobile.isDetected() === !1 && (i.webkitBackfaceVisibility = "hidden"), r = ["position: absolute", "display: block", "visibility: hidden", "height: 16px", "padding: 0 4px", "line-height: 16px", "background: #f00", "color: #fff", "font-size: 10px", "text-decoration: none", "font-family: 'Lucida Grande', 'Lucida Sans Unicode', Arial, Verdana, sans-serif", "border-radius: 3px", "box-shadow: 0 -1px 0px #f00, -1px 0 0px #f00, 1px 0 0px #f00, 0 1px 0px #f00, 0 0 2px #000", "border-top: 1px solid #f99"], -1 !== Utils.inArray(this.conf.chat_window.theme.name, ["modern", "postmodern", "minimal"]) && (r.push("width: 16px"), r.push("border-radius: 50%"), r.push("box-shadow: none"), r.push("border-top: 0"), r.push("padding: 0"), r.push("text-align: center"), r.push("font-family: 'Lato', sans-serif")), this.conf.group_properties.chat_window && "circle" === this.conf.group_properties.chat_window.theme.minimized ? (r.push("top: 23px"), r.push("right: 8px")) : (r.push("top: 12px"), r.push("left: 20px")), s = ["position: relative", "top: 20px", "left: 0", "width: 100%", "border: 0", "padding: 0", "margin: 0", "float: none", "background: none"], l = "about:blank", __lc.mute_csp_errors) {
        var u = function() {
          var e = document.getElementById("livechat-compact-view"),
            t = e && (e.contentWindow || e.contentDocument);
          if (!t) return void setTimeout(u, 300);
          var i = function(e) {
      ...
      o.innerHTML = '<iframe src="' + l + '" id="livechat-compact-view" style="' + s.join(";") + '" scrolling="no" frameborder="0" allowtransparency="true"></iframe><a id="livechat-badge" href="#" onclick="LC_API.show_full_view();return false" style="' + r.join(";") + '"></a>';
      var _ = this,
        h = function() {
          Minimized.init();
          var e = function(e) {
        ...
        m = function() {
          var e;
          return _.setLangPhrasesForMinimized(), _.embedded_chat_hidden_by_api = !1, Minimized.setLC2Theme(_.conf.chat_window.use_lc2_theme), Minimized.setTheme(_.conf.chat_window.theme.name, _.conf.chat_window.theme.color), _.conf.group_properties.chat_window && _.conf.group_properties.chat_window.theme.minimized && Minimized.setMinimizedTheme(_.conf.group_properties.chat_window.theme.minimized), Minimized.setOperatorsOnline("online" === _.conf.status), customStyle = new CustomStyle, "postmodern" !== _.conf.chat_window.theme.name || Mobile.isNewMobile() || (customStyle.parseCss("#livechat-full {height: 440px !important;}"), NotifyChild.send("update_body_height")), "minimal" === _.conf.chat_window.theme.name && (customStyle.parseCss("#livechat-full {width: 270px !important;height: 332px !important;}"), NotifyChild.send("update_body_height")), _.conf.chat_window.theme.css && (!Minimized.useLC2Theme() || "0" !== _.conf.chat_window.theme.customized && _.conf.chat_window.theme.customized !== !1) && (cssStyle = _.conf.chat_window.theme.css, Mobile.isNewMobile() && (cssStyle = customStyle.parseMobileCss(cssStyle)), cssStyle && (Minimized.setCustomCSS(cssStyle), NotifyChild.send("custom_css;" + encodeURIComponent(_.conf.chat_window.theme.css)), customStyle.parseCss(cssStyle) && NotifyChild.send("update_body_height"))), NotifyChild.send("mobile_input_blur"), e = $("livechat-compact-view"), e = e.contentWindow || e.contentDocument, e = e.document || e, Minimized.onRender(function() {
            Mobile.isDetected() && Mobile.isiOS() && (window.addEventListener("focusin", function(e) {
              var t = e.target && e.target.type;
              t && -1 !== Utils.inArray(t, ["email", "text", "url", "search", "number", "date", "textarea"]) && LC_API.chat_window_minimized() === !0 && (Minimized.hiddenByInputFocus = !0, Minimized.hide())
            ...
            Minimized.render()
          }, LC_API.new_mobile_is_detected() && Mobile.setWindowStyle(), "offline" !== _.conf.status || _.embedded_hide_when_offline() !== !0 || Chat.running() || Chat.waitingInQueue() ? _.embedded_chat_hidden_by_api === !0 ? (d("on_before_load"), !0) : void(_.conf.automatic_greeting || Chat.running() || Chat.waitingInQueue() || (d("on_before_load"), _.embedded_chat_hidden_by_api !== !0 && LC_API.minimize_chat_window({
            callAPI: !1
          }))) : (d("on_before_load"), LC_API.hide_chat_window(), !0)
        };
      ...
      var t, i, n;
      return e = e || {}, null == this.conf.integrations.firefly ? !1 : null == this.conf.integrations.firefly.api_key ? !1 : (window.fireflyAPI = {}, fireflyAPI.ready = function(e) {
        ...
        return "undefined" == typeof window.fireflyAPI.set ? !1 : (clearInterval(n),
          void e.callback())
      }, 300))))
    }, this.bindWindowEvents = function() {
      var e = this;
      return null == window.addEventListener ? !1 : (window.addEventListener("focus", function(e) {
      ...
      if (Cookie.set("lc_window_state", "full"), Minimized.newMessagesCounter = 0, $("livechat-badge").innerHTML = "", $("livechat-badge").style.visibility = "hidden", $("livechat-badge").style.opacity = 0, a === !1 && e.skill !== __lc_iframe_current_skill) e.skill = parseInt(e.skill, 10), __lc_iframe_current_skill = e.skill, __lc_iframe_src = Loader.getChatUrl({
      ...
      }, LC_Invite.msie ? LC_Invite.iframe_full_view_loaded = i : t.onload = i, t.src ? t.src = __lc_iframe_src_hash : null !== t.contentWindow && null !== t.contentWindow.location ? t.contentWindow.location = __lc_iframe_src_hash : t.setAttribute("src", __lc_iframe_src_hash);
      else {
        Minimized.updateText(), n = "1", document.activeElement && document.activeElement.tagName && (o = String(document.activeElement.tagName).toLowerCase(), "input" !== o && "textarea" !== o || (n = "0")), NotifyChild.send("maximize;" + n), $("livechat-compact-container").style.transform = "translateY(100%)";
        var s = window.getComputedStyle && getComputedStyle($("livechat-full")).transitionDuration || "200";
        s = -1 !== s.indexOf("ms") ? s.replace("ms", "") : -1 !== s.indexOf("s") ? 1e3 * s.replace("s", "") : 200, this.animationTimeout && clearTimeout(this.animationTimeout), this.animationTimeout = setTimeout(function() {
        ...
        }, s), $("livechat-eye-catcher") && ($("livechat-eye-catcher").style.visibility = "hidden", $("livechat-eye-catcher").style.opacity = 0), $("livechat-full").style.visibility = "visible", $("livechat-full").style.opacity = 1, $("livechat-full").style.zIndex = "2147483639", $("livechat-full").style.transform = "translateY(0%)"
      }
  ...
  var CustomVariablesParser = {
      ...
      getArrayByString: function(e) {
        ...
        try {
          if ("" === e || "$" === e) return "";
          for (e = IncorrectCharactersStripper.strip(e), n = [], o = e.split("&"), t = 0; t < o.length; t++)
            if (i = o[t].split("="), i[1]) try {
              i[0] = decodeURIComponent(i[0]), i[1] = decodeURIComponent(i[1]), n.push({
                name: i[0],
                value: i[1]
              })
            } catch (a) {}
    ...
    Pinger = function() {
      var e, t, i, n, o, a, s, r, l, c, d, u, _, h, m, f, p, g, b = 5,
        v = b,
        y = 18e5,
      ...
      return {
        init: function(o) {
          return e = o.config, t = o.app, i = o.minimized, n = o.loaderInfo, a = o.chatBetweenGroups, s = o.hostname, r = o.skill, l = o.visitorEmail, c = o.scriptVersion, d = o.embedded, m = o.statusChecker, n || (n = {
            pageData: {
              title: document.title,
              url: document.location.toString(),
              referrer: document.referrer
            },
            protocol: -1 != window.location.protocol.indexOf("https") ? "https://" : "http://"
    ...
    Utils = function() {
      ...
      return {
        ...
        makeItDone: function(e) {
          ...
          return {
            when: function(i) {
              var n, o, a, s = 100,
                r = function() {
                  return i() ? (clearInterval(o), e(), a = !0) : !1
                },
                l = function() {
                  t && t(), o = setInterval(r, n || s)
                };
        ...
        throttle: function(e, i) {
          ...
          return function() {
            if (a = this, s = [].slice.call(arguments), n = t(), !o) return void l();
            var e = i - (n - o);
            return e > 0 ? (clearTimeout(r), void(r = setTimeout(function() {
              l()
            }, e))) : void l()
          }
        },
        jsonpRequest: function(e) {
          e = e || {}, e.protocol = e.protocol || (-1 != window.location.protocol.indexOf("https") ? "https://" : "http://"), e.callback = e.callback || function() {}, e.requestName = e.requestName || "__lc_jsonp_request", e.queryParams = e.queryParams || {};
  ...
  (function() {
    function e(t, n) {
        ...
        if ("bug-string-char-index" == e) t = "a" != "a" [0];
          ...
          if ("json-stringify" == e) {
            ...
            d && ((o = function() {
              ...
              d = "0" === i(0) && "0" === i(new l) && '""' == i(new c) && i(b) === p && i(p) === p && i() === p && "1" === i(o) && "[1]" == i([o]) && "[null]" == i([p]) && "null" == i(null) && "[null,null,null]" == i([p, b, null]) && i({
                a: [o, !0, !1, null, "\x00\b\n\f\r  "]
              }) == r && "1" === i(null, o) && "[\n 1,\n 2\n]" == i([1, 2], null, 1)
            }, function() {
              d = !1
          ...
          if ("json-parse" == e) {
            ...
            "function" == typeof h && a(function() {
              0 !== h("0") || h(!1) || (o = h(r), _ = 5 == o.a.length && 1 === o.a[0], _ && (a(function() {
                _ = !h('" "')
              }), _ && a(function() {
                _ = 1 !== h("01")
              }), _ && a(function() {
      ...
      if (a(function() {
        ...
        var w = "[object Function]",
          ...
          M = "[object Array]",
          x = "[object Boolean]",
          T = s("bug-string-char-index"),
          L = function(e, t) {
            var n, o, a, s = 0;
            (n = function() {
              this.valueOf = 0
            }).prototype.valueOf = 0, o = new n;
            for (a in o) v.call(o, a) && s++;
            return n = o = null, s ? L = function(e, t) {
              ...
              var n, a, s = b.call(e) == w,
                r = !s && "function" != typeof e.constructor && i[typeof e.hasOwnProperty] && e.hasOwnProperty || v;
              for (n in e) s && "prototype" == n || !r.call(e, n) || t(n);
              for (a = o.length; n = o[--a]; r.call(e, n) && t(n));
            }), L(e, t)
          };
        if (!s("json-stringify") && !s("date-serialization")) {
          var k = {
            ...
            D = function(e) {
              var t, i, n, o, a, s, r, l, c;
              if (y) t = function(e) {
                i = e.getUTCFullYear(), n = e.getUTCMonth(), o = e.getUTCDate(), s = e.getUTCHours(), r = e.getUTCMinutes(), l = e.getUTCSeconds(), c = e.getUTCMilliseconds()
              };
              else {
                var d = m.floor,
                ...
                t = function(e) {
                  ...
                  o = 1 + o - _(i, n), a = (e % 864e5 + 864e5) % 864e5, s = d(a / 36e5) % 24, r = d(a / 6e4) % 60, l = d(a / 1e3) % 60, c = a % 1e3
                }
              }
              return (D = function(e) {
                return e > -1 / 0 && 1 / 0 > e ? (t(e), e = (0 >= i || i >= 1e4 ? (0 > i ? "-" : "+") + S(6, 0 > i ? -i : i) : S(4, i)) + "-" + S(2, n + 1) + "-" + S(2, o) + "T" + S(2, s) + ":" + S(2, r) + ":" + S(2, l) + "." + S(3, c) + "Z", i = n = o = s = r = l = c = null) : e = null, e
              })(e)
            };
          if (s("json-stringify") && !s("date-serialization")) {
            var P = n.stringify;
            ...
            var N = "\\u00",
              ...
              E = /[\x00-\x1f\x22\x5c]/g,
              O = function(e) {
                return E.lastIndex = 0, '"' + (E.test(e) ? e.replace(E, B) : e) + '"'
              },
              R = function(e, t, i, n, o, s, r) {
                ...
                if ("object" == typeof l) {
                  for (g = r.length; g--;)
                    if (r[g] === l) throw h();
                  if (r.push(l), _ = [], v = s, s += o, d == M) {
                    for (f = 0, g = l.length; g > f; f++) m = R(f, l, i, n, o, s, r), _.push(m === p ? "null" : m);
                    y = _.length ? o ? "[\n" + s + _.join(",\n" + s) + "\n" + v + "]" : "[" + _.join(",") + "]" : "[]"
                  } else L(n || l, function(e) {
                    var t = R(e, l, i, n, o, s, r);
                    t !== p && _.push(O(e) + ":" + (o ? " " : "") + t)
                  }), y = _.length ? o ? "{\n" + s + _.join(",\n" + s) + "\n" + v + "}" : "{" + _.join(",") + "}" : "{}";
                  return r.pop(), y
                }
            ...
            n.stringify = function(e, t, n) {
              var o, a, s, r;
              if (i[typeof t] && t)
                if (r = b.call(t), r == w) a = t;
                else if (r == M) {
                s = {};
                for (var l, c = 0, d = t.length; d > c; l = t[c++], r = b.call(l), (r == I || r == C) && (s[l] = 1));
              }
              if (n)
                if (r = b.call(n), r == C) {
                  if ((n -= n % 1) > 0)
                    for (o = "", n > 10 && (n = 10); o.length < n; o += " ");
                } else r == I && (o = n.length <= 10 ? n : n.slice(0, 10));
              return R("", (l = {}, l[""] = e, l), a, s, o, "", [])
            }
          }
        }
        if (!s("json-parse")) {
          var $, U, W = c.fromCharCode,
            H = {
              92: "\\",
              34: '"',
              47: "/",
            ...
            F = function() {
              for (var e, t, i, n, o, a = U, s = a.length; s > $;) switch (o = a.charCodeAt($)) {
                case 9:
                case 10:
                case 13:
                case 32:
                ...
                case 34:
                  for (e = "@", $++; s > $;)
                    if (o = a.charCodeAt($), 32 > o) j();
                    else if (92 == o) switch (o = a.charCodeAt(++$)) {
                    case 92:
                    case 34:
                    case 47:
                    case 98:
                    ...
                    case 114:
                      ...
                      break;
                    case 117:
                      for (t = ++$, i = $ + 4; i > $; $++) o = a.charCodeAt($), o >= 48 && 57 >= o || o >= 97 && 102 >= o || o >= 65 && 70 >= o || j();
                      e += W("0x" + a.slice(t, $));
                      break;
                    default:
                      j()
                  ...
                  j();
                default:
                  if (t = $, 45 == o && (n = !0, o = a.charCodeAt(++$)), o >= 48 && 57 >= o) {
                    for (48 == o && (o = a.charCodeAt($ + 1), o >= 48 && 57 >= o) && j(), n = !1; s > $ && (o = a.charCodeAt($), o >= 48 && 57 >= o); $++);
                    if (46 == a.charCodeAt($)) {
                      for (i = ++$; s > i && (o = a.charCodeAt(i), o >= 48 && 57 >= o); i++);
                      i == $ && j(), $ = i
                    }
                    if (o = a.charCodeAt($), 101 == o || 69 == o) {
                      for (o = a.charCodeAt(++$), 43 != o && 45 != o || $++, i = $; s > i && (o = a.charCodeAt(i), o >= 48 && 57 >= o); i++);
                      i == $ && j(), $ = i
                    }
                    return +a.slice(t, $)
                  }
                  n && j();
                  var r = a.slice($, $ + 4);
                  if ("true" == r) return $ += 4, !0;
                  if ("fals" == r && 101 == a.charCodeAt($ + 4)) return $ += 5, !1;
                  if ("null" == r) return $ += 4, null;
                  j()
              }
              return "$"
            },
    ...
    if (!a || a.global !== a && a.window !== a && a.self !== a || (o = a), n && !t) e(o, n);
    else {
      var s = o.JSON,
        r = o.JSON3,
        l = !1,
        c = e(o, o.JSON3 = {
          noConflict: function() {
            return l || (l = !0, o.JSON = s, o.JSON3 = r, s = r = null), c
          }
        });
      o.JSON = {
        parse: c.parse,
  ...
  var AnalyticsIntegrations = {
      ...
      trackPageView: function(e, t) {
        t = t || {}, t.nonInteraction = t.nonInteraction || !1, t.onlyMainWindow = "undefined" != typeof t.onlyMainWindow ? t.onlyMainWindow : !0, t.event_data && this.removeEmptyValues(t.event_data);
        for (var i = 0; i < this.enabledIntegrations.length; i++) - 1 !== Utils.inArray(e, this.enabledIntegrations[i].events) && this.enabledIntegrations[i].callback(e, t)
      },
    ...
    AutoInvitation = {
      render: function(e, t) {
        ...
        return e.error ? !1 : (t = t || {}, window.LC_AutoInvite = new i, window.LC_AutoInvite.config = e, window.LC_AutoInvite.config.position = {
          arg1: e.position.y,
          arg2: e.position.x,
  ...
  var Chat = {
    ...
    Cookie = {
      set: function(e, t, i) {
        var n, o, a, s, r;
        i ? (a = new Date, a.setTime(a.getTime() + 24 * i * 60 * 60 * 1e3), s = "; expires=" + a.toGMTString()) : s = "", r = location.host, 1 === r.split(".").length ? (__lc.chat_between_groups === !1 && __lc.skill > 0 && (e = e + ".group" + __lc.skill), document.cookie = e + "=" + t + s + "; path=/") : (o = r.split("."), o.shift(), n = "." + o.join("."), __lc.chat_between_groups === !1 && __lc.skill > 0 && (e = e + ".group" + __lc.skill), document.cookie = e + "=" + t + s + "; path=/; domain=" + n, null != Cookie.get(e) && Cookie.get(e) == t || (n = "." + r, document.cookie = e + "=" + t + s + "; path=/; domain=" + n))
      },
      get: function(e) {
    ...
    Events = {
      ...
      sendStoredMetrics: function() {
        var e, t;
        for (e = 0; e < this._storedMetrics.length; e++) t = this._storedMetrics[e], this.track("chat_window_speed", t)
      },
      trackSpeed: function(e, t) {
        ...
        this._receivedEvents.push(e), null == this._sendSpeedEvent && (this._sendSpeedEvent = Math.random() < 2e-4), this.isErlang() && (this._sendSpeedEvent = Math.random() < .5);
        var i = (new Date).getTime(),
          n = i - performance.timing.navigationStart,
          o = "",
          a = "";
        return t && (o = " " + t), a = e + " " + Timer.checkpoint() + " " + n + " " + this.isErlang() + o, this._sendSpeedEvent !== !0 ? (this._storedMetrics.push(a), !1) : void this.track("chat_window_speed", a)
      }
    },
    EyeCatcher = {
      imageAppended: !1,
      ...
      shouldBeDisplayed: function() {
        return LC_API.mobile_is_detected() || LC_API.new_mobile_is_detected() ? !1 : this.enabled() === !0 && "1" !== Cookie.get("hide_eye_catcher")
      },
      ...
      setState: function(e) {
        var t;
        return (t = $("livechat-eye-catcher")) ? void("online" === e && LC_API.chat_window_minimized() && !LC_Invite.embedded_chat_hidden_by_api ? (this.imageAppended === !1 && this.appendImage(), t.style.visibility = "visible") : t.style.visibility = "hidden") : !1
      }
    },
    Full = {
      _loaded: !1,
    ...
    GoogleAnalytics = {
      ...
      _trackga: function(e, t, i) {
        gaName = window.GoogleAnalyticsObject || "ga", "function" == typeof window[gaName] && function() {
          var e = !1;
          return window[gaName](function(t) {
            "object" == typeof t && (e = !0)
          }), e
        }() && window[gaName]("send", {
          hitType: "event",
      ...
      _doTrack: function(e, t, i) {
        ...
        return n && this["_track" + n] ? this["_track" + n](e, t, i) : void 0
      },
      track: function(e, t) {
    ...
    Minimized = {
      ...
      init: function() {
        return LC_API.embedded_chat_enabled() === !1 ? !1 : (this.inited = !0, __lc_settings.automatic_greeting && Minimized.setState(Minimized.STATE_INVITATION_WITH_AGENT), this.originalTitle = Loader.pageData.title, this.checkIfTabActive(), this.mobileInvitationOpened = Cookie.get("lc_mobile_invitation_opened"), void(this.invitationOpened = Cookie.get("lc_invitation_opened")))
      },
      __t: function() {
        var e, t;
        if (e = "", t = arguments[0], "undefined" == typeof this.langPhrases[t]) return "";
        if (e = this.langPhrases[t], arguments[1])
          for (var i in arguments[1]) e = e.replace("%" + i + "%", arguments[1][i]), e = e.replace("%" + i, arguments[1][i]);
        return e
      },
      ...
      modifyColor: function(e, t) {
        ...
        for (var o = 0; 3 > o; o++) n = parseInt(e.substr(2 * o, 2), 16), n = Math.round(Math.min(Math.max(0, n + n * t), 255)).toString(16), i += ("00" + n).substr(n.length);
        return i
      },
      ...
      shouldRenderRoundedMinimized: function(e, t, i, n) {
        return 8 === Minimized.isInternetExplorer() ? !1 : "oldMobile" !== e && "circle" === i ? !0 : "newMobile" === e && (t === Minimized.STATE_CHATTING || t === Minimized.STATE_INVITATION_WITH_AGENT)
      },
      shouldRenderRoundedMinimizedText: function(e, t, i, n) {
        return 8 === Minimized.isInternetExplorer() ? !1 : ("newMobile" !== e || t !== Minimized.STATE_CHATTING && t !== Minimized.STATE_INVITATION_WITH_AGENT || n) && ("desktop" !== e || t !== Minimized.STATE_CHATTING || n) ? "desktop" === e && t === Minimized.STATE_INVITATION_WITH_AGENT : !0
      },
      addMinimizedClass: function(e) {
        var t = Minimized.getIFrameBody();
        return t && t.body ? (t = t.body, -1 !== t.className.indexOf(e) ? !0 : void(t.className = t.className + " " + e)) : !1
      },
      ...
      render: function() {
        ...
        if (this.$iframeBody = Minimized.getIFrameBody(), this.invitationOpened = Cookie.get("lc_invitation_opened"), isNewMobile = Mobile.isNewMobile(), a = Mobile.isNewMobile() ? "new-mobile" : "", circleInvitation = Minimized.shouldRenderRoundedMinimized(Minimized.getPlatform(), this.state, this.getMinimizedTheme(), "opened" === Minimized.invitationOpened), circleInvitationText = Minimized.shouldRenderRoundedMinimizedText(Minimized.getPlatform(), this.state, this.getMinimizedTheme(), "opened" === Minimized.invitationOpened), o = circleInvitationText ? "table-cell" : "none", circleInvitation ? (n = "none", s = "block", this.setCompactSize(circleInvitationText), circleInvitationText ? Mobile.setContainerSize("normal") : Mobile.setContainerSize("small")) : (n = "block", s = "none", this.setNormalSize(), Mobile.setContainerSize("normal")), l = !1, /trident/i.test(navigator.userAgent) && (c = /(ie) ([\w.]+)/i.exec(navigator.userAgent) || [], d = c[2], d && parseInt(d, 10) <= 8 && (l = !0)), t = "", this.styles[this.theme + "Fonts"] ? (t += decodeURI(this.styles[this.theme + "Fonts"]), t += decodeURI(this.styles[this.theme + "CSS"])) : t += decodeURI(this.styles[this.theme]), Mobile.isNewMobile() && (t += decodeURI(this.styles.mobileFonts), t += decodeURI(this.styles.mobileCSS)), t = t.replace(/url\(\'\/\//g, "url('" + (-1 != window.location.protocol.indexOf("https") ? "https://" : "http://")), t = this.useLC2Theme() === !0 ? decodeURI("#content-container%7Bposition:absolute;top:0;right:0;bottom:0;left:0;width:100%25;height:100%25;z-index:6;line-height:22px%7D#content%7Bborder-radius:10px%2010px%200%200;box-shadow:inset%201px%201px%201px%20rgba(255,255,255,.2)%7D#content%20#full-view-button%7Bdisplay:block;position:relative;padding:0;outline:0;color:#fff;font-size:14px;text-decoration:none;font-weight:700%7D#content%20#open-label%7Bdisplay:block;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;padding:6px%2015px%7D.lc2%20#content%20#open-icon%7Bfloat:right;position:relative%7D#mobile_invitation_container%7Bposition:absolute;left:0;right:0;width:100%25;font-size:.9em%7D#mobile_invitation_container:hover%7Bcursor:pointer%7D.invitation_message%7Bmargin-right:1em;display:table-cell;vertical-align:middle;width:100%25%7D#operator_avatar_container%7Bdisplay:table-cell;padding:.1em%7D#invitation_message_text%7Bfloat:right;color:#4a546c;background:#e7eaf1;border-radius:.3em;font-size:1em;padding:.7em%20.9em;margin-right:.8em;max-height:3.2em;line-height:1.15em;overflow:hidden;display:block;border:1px%20solid%20rgba(0,0,0,.07);box-shadow:0%201px%205px%20rgba(0,0,0,.1);margin-left:.5em%7D.invitation_message:after%7Bborder:.5em%20solid%20transparent;border-color:transparent%20transparent%20transparent%20#DFE1E4;display:block;position:absolute;content:%22%22;margin-top:.5em;right:5.1em;top:1.5em%7D#operator_avatar%7Bfloat:right;border-radius:50%25;width:4.5em;height:4.5em;box-shadow:0%201px%203px%20rgba(0,0,0,.2);border:.3em%20solid%20#fff;box-sizing:content-box;overflow:hidden;color:#fff;text-align:center;position:relative;transition:background-color%20.2s%20ease-in-out%20.2s;-webkit-transition:background-color%20.2s%20ease-in-out%20.2s;-ms-transition:background-color%20.2s%20ease-in-out%20.2s;-o-transition:background-color%20.2s%20ease-in-out%20.2s%7D.avatar-loaded%20#operator_avatar%7Bbackground-color:#fff%7D#operator_avatar%20img%7Bwidth:0;height:0;border-radius:50%25;overflow:hidden;box-sizing:border-box;margin-top:50%25;margin-left:50%25;opacity:.5;position:absolute;top:0;left:0;transition:all%201s;-webkit-transition:all%20.2s%20ease-in-out;-moz-transition:all%20.2s%20ease-in-out;-ms-transition:all%20.2s%20ease-in-out;-o-transition:all%20.2s%20ease-in-out%7D.avatar-loaded%20#operator_avatar%20img%7Bwidth:4.5em;height:4.5em;margin-top:0;margin-left:0;opacity:1;background-color:#fff%7D#content-container.new-mobile%20#content,#extra.new-mobile%7Bmargin-top:1.5em!important;border-radius:.5em!important%7D#extra.new-mobile%7Bleft:.5em!important;right:.5em!important;width:auto!important%7D#content%20%5Bclass*=%22%20icon-%22%5D,#content%20%5Bclass%5E=icon-%5D%7B-webkit-font-smoothing:none%7D.icon-agentonline:before%7Bfont-size:2em%7D.icon-leavemessage:before%7Bfont-size:1.8em%7D.icon-leavemessage%7Bline-height:4.5em!important%7D.icon-agentonline%7Bline-height:4.6em!important%7D") + t : decodeURI(".lc1%20#content%20#full-view-button,body%7Bfont-family:'Lucida%20Grande','Lucida%20Sans%20Unicode',Arial,Verdana,sans-serif%7D.lc1%20#content-container%7Bposition:absolute;top:0;right:0;bottom:0;left:0;width:100%25;height:100%25;z-index:6;line-height:22px%7D.lc1%20#content%7Bmargin:7px%207px%200;padding:2px%208px;border-radius:10px%2010px%200%200%7D.lc1%20#content%20#full-view-button%7Bdisplay:block;position:relative;padding:0;outline:0;color:#fff;font-size:14px;text-decoration:none;font-weight:700%7D.lc1%20#content%20#open-label%7Bdisplay:block;overflow:hidden;white-space:nowrap;text-overflow:ellipsis%7D.lc1%20#content%20#open-icon%7Bposition:relative;display:block;float:right;width:19px;height:19px;margin-top:2px;background-repeat:no-repeat;background-position:-16px%20-153px%7D.lc1.http%20#content%20#open-icon%7Bbackground-image:url(http://cdn.livechatinc.com/img/sprite.20111206.png)%7D.lc1.https%20#content%20#open-icon%7Bbackground-image:url(https://cdn.livechatinc.com/img/sprite.20111206.png)%7D#extra%7Bdisplay:block;position:absolute;top:0;right:0;bottom:0;left:0;width:100%25;height:100%25;z-index:5;border-radius:15px%2015px%200%200%7D") + t, t += this.styleForTheme(this.theme, this.color), this.custom_css.length && (t += this.custom_css), e = "", l || (e += '<style type="text/css">' + t + "</style>"), this.useLC2Theme() === !0 ? (_ = "display:" + n, h = a, r = '<span id="open-icon" class="icon-maximize"></span>') : (e += '<div id="extra"></div>', r = '<span id="open-icon"></span>'), e += '<div id="content-container" ' + (_ ? 'style="' + _ + '" ' : "") + (h ? 'class="' + h + '"' : "") + '>  <div id="content">  <a id="full-view-button" href="javascript:void(null)"', __lc.mute_csp_errors || (e += ' onclick="parent.LC_API.open_chat_window()"'), e += ">" + r + '<span id="open-label">' + this.escapeString(this.text_label) + "</span></a> </div></div>", this.supportRoundedInvitations()) {
          ...
          f = this.operator_avatar_url && "" !== this.operator_avatar_url && this.getDisplayAvatar() && (Minimized.state === Minimized.STATE_CHATTING || Minimized.state === Minimized.STATE_INVITATION_WITH_AGENT) ? '<span class="icon-agentonline"></span><img src="//' + this.operator_avatar_url + '">' : Minimized.state === Minimized.STATE_OFFLINE ? '<span class="icon-leavemessage"></span>' : '<span class="icon-agentonline"></span>',
            e = e + '<div id="mobile_invitation_container" style="display:' + s + '"><div', __lc.mute_csp_errors || (e += ' onclick="parent.LC_API.open_chat_window(); return false"'), e += ' class="invitation_message" style="display:' + o + '"><div id="invitation_message_text">' + this.escapeString(this.mobileInvitationText) + o + '</div></div><div id="operator_avatar_container"><div id="operator_avatar"', __lc.mute_csp_errors || (e += ' onclick="parent.LC_API.open_chat_window(); return false"'), e += ">" + f + "</div></div></div>"
        }
        u.push(this.useLC2Theme() ? "lc2" : "lc1"), u.push(-1 != window.location.protocol.indexOf("https") ? "https" : "http"), Utils.makeItDone(function() {
      ...
      setOperatorDisplayName: function(e) {
        return this.inited === !1 ? !1 : (this.operator_display_name = e, this.setOperatorName(e), this.updateText(), this.updateWindowHTML(), void(this.titleNotification = this.__t("Embedded_new_message", {
          operator: this.operator_display_name
        })))
      },
      setOperatorAvatarUrl: function(e) {
        return this.inited === !1 ? !1 : (this.operator_avatar_url = e, void this.updateWindowHTML())
      },
      ...
      newMessageNotification: function(e) {
        var t;
        return this.inited === !1 ? !1 : this.tabActive === !0 && LC_API.chat_window_maximized() === !0 ? !0 : (LC_API.chat_window_minimized() === !0 && this._setText(this.__t("Embedded_new_message", {
          operator: this.operator_display_name
      ...
      disableNewMessageNotification: function() {
        return this.inited === !1 ? !1 : ($("livechat-badge").innerHTML = "", $("livechat-badge").style.visibility = "hidden", $("livechat-badge").style.opacity = 0, this.animateTitleTag({
          force_hide: !0
    ...
    Mobile = {
      ...
      isOldAndroid: function() {
        ...
        var e = (parseInt(this.getAndroidVersion(), 10), parseFloat(this.getAndroidVersion())),
          t = Mobile.userAgent && Mobile.isAndroid() && (Mobile.getAppleWebkitVersion() < 537 || Mobile.isSamsung() && 4.4 > e);
        return t
      },
      ...
      getAppleWebkitVersion: function() {
        var e = new RegExp(/AppleWebKit\/([\d.]+)/),
          t = e.exec(Mobile.userAgent),
          i = null === t ? null : parseFloat(e.exec(Mobile.userAgent)[1]);
        return i
      },
      ...
      resizeMobileWindow: function(e) {
        ...
        var t, i, n, o = document.getElementById("livechat-compact-container"),
          a = document.getElementById("livechat-full"),
          s = document.getElementById("livechat-badge");
        return e.orientationReset ? (Mobile.customStyle.cssProperties(a, {
          ...
          width: t.width + "px",
          height: t.height + "px"
        }), Mobile.customStyle.cssProperties(s, {
      ...
      preloadSound: function() {
        var e, t = this;
        return $("livechat_sound") ? !1 : (e = document.createElement("audio"), e.setAttribute("id", "livechat_sound"), e.setAttribute("style", "position:absolute;top:-9999em;left:-9999em;visibility:hidden"), e.innerHTML = ['<source src="//cdn.livechatinc.com/sounds/message.ogg" type="audio/ogg" />', '<source src="//cdn.livechatinc.com/sounds/message.mp3" type="audio/mp3" />', '<source src="//cdn.livechatinc.com/sounds/message.wav" type="audio/wav" />'].join("\n"), void DOM.appendToBody(e, function() {
    ...
    NotifyChild = {
      ...
      send: function(e) {
        ...
        return t ? (XD.postMessage(encodeURIComponent(e), __lc_iframe_src_hash, t), !1) : !1
      },
      ...
      receive: function(e) {
        ...
        if (Loader.is_iframe_loaded = !0, t = e.data, t = decodeURIComponent(t), "load_languages" === t) {
        ...
        } else if ("load_window_config" === t) this.manualInvitation && (r = {
          skipPrechat: !0
        }), LC_Invite.sendWindowConfigToEmbedded(r);
        ...
        else if (/^message_sent;/.test(t)) window.LC_AutoInvite && window.LC_AutoInvite.ignoreFirstMessage ? (window.LC_AutoInvite.ignoreFirstMessage = !1, window.LC_AutoInvite.autoInvited = !1) : LC_API.on_message({
          ...
          var f = t.split(";"),
            p = JSON.parse(decodeURIComponent(f[2]));
        ...
        else if ("minimize" == t) LC_API.chat_window_hidden() === !1 && LC_API.minimize_chat_window();
        ...
        else if (/^operator;/.test(t)) a = decodeURIComponent(t.split(";")[1]), avatar_url = decodeURIComponent(t.split(";")[2]), Minimized.setOperatorDisplayName(a), Minimized.setOperatorAvatarUrl(avatar_url);
        else if (/^chat_id;/.test(t)) s = decodeURIComponent(t.split(";")[1]), s ? LC_Invite.chat_id = s : LC_Invite.chat_id = null;
        else if (/^visitor_name;/.test(t)) i = t.split(";"), Minimized.setVisitorName(i[1]);
        else if (/^state;/.test(t)) i = t.split(";"), Minimized.setState(i[1]), Minimized.updateText(), LC_Invite.embedded_hide_when_offline() !== !0 || LC_Invite.getVisitorInteraction() || (Minimized.getState() === Minimized.STATE_OFFLINE ? LC_Invite.hideChatWindow() : Minimized.getPreviousState() !== Minimized.STATE_OFFLINE || LC_Invite.embedded_chat_hidden_by_api || LC_API.minimize_chat_window());
        ...
        else if (/^pushpage;/.test(t)) i = t.split(";"), window.location.href = i[1];
          ...
          i = t.split(";");
          var y = decodeURIComponent(i[1]),
            w = decodeURIComponent(i[2]);
          if (w) var A = JSON.parse(w);
          var C = decodeURIComponent(i[3]);
          if (C) var I = JSON.parse(C);
          AnalyticsIntegrations.trackPageView(y, {
            event_data: A,
            user_data: I
          })
        } else if (/^init;/.test(t)) {
          var M = function() {
            ...
            var e, o, a;
            return i = t.split(";"), Minimized.setDisplayAvatar(LC_Invite.conf.chat_window.display_avatar), "" !== i[7] && (Minimized.setState(i[7]), Minimized.updateText()), e = i[7] == Minimized.STATE_CHATTING, o = i[7] == Minimized.STATE_QUEUE, a = LC_Invite.embedded_hide_when_offline(), "" !== i[8] && Minimized.setOperatorDisplayName(decodeURIComponent(i[8])), "" !== i[10] && Minimized.setOperatorAvatarUrl(decodeURIComponent(i[10])), "true" === i[11] && (Events.setErlang(!0), Events.sendStoredMetrics()), "" !== __lc_settings.nick && "$" !== __lc_settings.nick && NotifyChild.send("nick;" + encodeURIComponent(__lc_settings.nick)), "" !== __lc_settings.email && NotifyChild.send("email;" + encodeURIComponent(__lc_settings.email)), "" !== __lc_settings.lc.params && __lc_settings.lc.params !== !1 && NotifyChild.send("params;" + encodeURIComponent(__lc_settings.lc.params)), l.chat_reloaded === !0 && (l.manualInvitation && NotifyChild.send("manual_invitation"), NotifyChild.send("welcome_message;" + encodeURIComponent(l.welcome_message || "")), LC_API.show_full_view(), l.welcome_message = null, l.manualInvitation = !1), __lc_settings.client_limit_exceeded === !0 && NotifyChild.send("client_limit_exceeded"), __lc.wix && NotifyChild.send("wix;" + encodeURIComponent(Loader.pageData.url)), __lc.always_start_chat && NotifyChild.send("always_start_chat"), c("on_before_load"), Minimized.getState() === Minimized.STATE_OFFLINE && a === !0 ? (LC_API.hide_chat_window(), c("on_after_load"), Full.onload(), !0) : LC_Invite.embedded_chat_hidden_by_api === !0 ? (c("on_after_load"), Full.onload(), !0) : (__lc_settings.automatic_greeting && ("full" === Cookie.get("lc_window_state") && (l.maximize_on_init = !0),
              LC_Invite.trackAndRenderAutoInvitation(__lc_settings.automatic_greeting)), e === !0 || o === !0 || l.chat_reloaded === !0 || l.maximize_on_init === !0 ? (n = Cookie.get("lc_window_state"), "full" === n || l.maximize_on_init === !0 ? (LC_API.open_chat_window(), l.maximize_on_init = !1) : LC_API.minimize_chat_window({
              callAPI: !1
            })) : LC_API.minimize_chat_window({
              callAPI: !1
            }), c("on_after_load"), Full.onload(), Events.trackSpeed("show_minimized"), void(LC_API.new_mobile_is_detected() && Mobile.setWindowStyle()))
          };
          Utils.makeItDone(M).when(function() {
    ...
    PersonalInvitation = {
      render: function(e) {
        ...
        return e.error ? !1 : (window.LC_PrivateInvite = new t, window.LC_PrivateInvite.config = e, window.LC_PrivateInvite.config.position = {
          arg1: e.position.y,
          arg2: e.position.x,
          option: e.position.h_align
  ...
  var XD = function() {
      ...
      return {
        ...
        receiveMessage: function(i, n) {
          t.postMessage && (i && (e = function(e) {
            return "string" == typeof n && e.origin !== n || "[object Function]" === Object.prototype.toString.call(n) && n(e.origin) === !1 ? !1 : void i(e)
    ...
    VisitorDetailsParser = {
      parse: function(e) {
        return "object" != typeof e ? !1 : e.constructor !== Object ? !1 : ("undefined" != typeof e.name && (e.name = String(e.name), __lc_settings.nick = IncorrectCharactersStripper.strip(e.name)), void("undefined" != typeof e.email && (e.email = String(e.email), __lc_settings.email = IncorrectCharactersStripper.strip(e.email))))
      }
    },
  ...
  var JSON = {
    ...
    __script_data_response, __lc_script_tracking_version = {},
    __lc = window.__lc || {};
  if (__lc.license = parseInt(__lc.license, 10) || null, __lc.skill = function() {
      ...
      tracking_env: "Prod",
      tracking_version: "20160923125829"
    }, null == __lc.license)
    for (col = document.getElementsByTagName("script"), i = 0; i < col.length; i++)
      if (src = col[i].src, src && (matches = src.match(/licence\/(\d+)\/script.cgi(.*)$/), matches && (__lc.license = parseInt(matches[1], 10), query_matches = matches[2].match(/groups=(\d+)/), query_matches && (__lc.skill = parseInt(query_matches[1], 10)), query_matches = matches[2].match(/params=([^&]+)/)))) try {
  ...
  var Loader = {
    ...
    init: function() {
      ...
      if (__lc.wix) Wix.getSiteInfo(function(e) {
        Loader.pageData.title = e.pageTitle, "undefined" != typeof e.referrer ? Loader.pageData.referrer = e.referrer : Loader.pageData.referrer = e.referer, e.baseUrl.length > 0 && -1 === e.url.indexOf(e.baseUrl) ? Loader.pageData.url = e.baseUrl : Loader.pageData.url = e.url, Loader.loadData()
      });
    ...
    parseScriptDataResponse: function(e, t, i) {
      var n = __lc.params || e.visitor && e.visitor.params,
        o = {
          ...
          lang: e.lang,
          client_limit_exceeded: "undefined" == typeof e.client_limit_exceeded ? !1 : Boolean(Number(e.client_limit_exceeded)),
    ...
    scriptDataRequest: function(e, t, i, n, o, a, s, r) {
      var l = document.createElement("script"),
        c = "";
      Loader.requestTime = (new Date).getTime(), c += "t=" + +new Date, c += "&referrer=" + encodeURIComponent(IncorrectCharactersStripper.strip(a)), c += "&url=" + encodeURIComponent(n), c += "&params=" + encodeURIComponent(CustomVariablesParser.parse(o)), c += "&jsonp=__lc_data_" + i, 1 === s && (c += "&test=1"), "undefined" != typeof t && (t = parseInt(t, 10), c += "&groups=" + (t || 0)), r === !1 && "undefined" != typeof t ? l.src = Loader.protocol + __lc.hostname + "/licence/g" + e + "_" + t + "/script_data.js?" + c : l.src = Loader.protocol + __lc.hostname + "/licence/" + e + "/script_data.js?" + c, DOM.appendToBody(l)
    },
    loadData: function() {
      var e, t = this;
      ...
      window["__lc_data_" + e] = function(i) {
        if (!t.wasIDUsed(e)) {
          var n, o, a, s = 15;
          if (t.addUsedID(e), a = (new Date).getTime() - Loader.requestTime, Events.trackSpeed("script_data", a), "undefined" != typeof i.error) return t.parseResponseError(i.error), !1;
          n = t.calculateWindowDimensions(s), window.__lc_lang = function(e) {
            var t = e.localization;
            LC_Invite.conf.lang_phrases = t, LC_Invite.sendLangPhrasesToEmbedded(t)
          }, o = document.createElement("script"), o.src = Loader.protocol + __lc.hostname + i.localization_url + "?jsonp=__lc_lang", DOM.appendToBody(o), __script_data_response = i, __lc_settings = t.parseScriptDataResponse(__script_data_response, s, n), t.initMainScript(__lc_settings, __script_data_response), t.pendingScriptDataRequest = !1
        }
    ...
    calculateWindowDimensions: function(e) {
      var t, i = 400;
      return window.screen && window.screen.availWidth ? i = window.screen.availWidth : window.innerWidth ? i = window.innerWidth : document.body && document.body.clientWidth && (i = document.body.clientWidth), i = parseInt(i, 10), 400 > i ? (t = i - 2 * e, {
        w: t,
        w_minimized: t,
        h: 350
      }) : {
    ...
    getChatUrl: function(e, t) {
      var i, n, o, a, s;
      e = e || {}, t = t || {}, o = "?", null != __lc.chat_absolute_url ? (/\?/.test(__lc.chat_absolute_url) && (o = "&"), i = __lc.chat_absolute_url + o + "license=" + __lc_settings.lic, __lc.hostname && /^(server\d+\.labs|labs|server-lc|secure|secure-labs)\.livechatinc\.com(:\d+)?$/.test(__lc.hostname) && (i += "&server=" + __lc.hostname), o = "&") : (i = t.force_ssl ? "https://" : Loader.protocol, skillUrlPart = "", "undefined" != typeof __lc.skill && (s = parseInt(__lc.skill, 10), skillUrlPart = "_" + (s || 0)), i += __lc.chat_between_groups === !1 ? __lc_settings.serv + "/licence/g" + __lc_settings.lic + skillUrlPart + "/open_chat.cgi" : __lc_settings.serv + "/licence/" + __lc_settings.lic + "/open_chat.cgi"), __lc.chat_between_groups === !1 && (e.unique_group = "1"), a = [];
      for (n in e) e.hasOwnProperty(n) && a.push(n + "=" + encodeURIComponent(e[n]));
      return i += o + a.join("&"), o = "&", i += o + "session_id=" + LC_API.get_visitor_id(), t.include_current_page_address && (i += "#" + encodeURIComponent(Loader.pageData.url)), i
    },
    wasIDUsed: function(e) {
      return this.usedCallbackIDs[e] ? !0 : void 0
    },
  ...
  DOM.ready(Loader.init), LC_API = {
    ...
    open_chat_window: function() {
      LC_Invite.setVisitorInteraction(!0), "popup" === this.get_window_type() || Mobile.isOldMobile() ? Mobile.isDetected() ? this.open_mobile_window() : LC_Invite.lc_open_chat() : Full.isLoaded() ? Mobile.isDetected() ? this.open_mobile_window() : this.show_full_view() : (Minimized.displayLoadingMessage(), Full.onAfterLoad(function() {
    ...
    display_embedded_invitation: function(e, t, i, n, o) {
      var a, s, r = this;
      return this.embedded_chat_enabled() === !1 && "undefined" != typeof LC_AutoInvite ? (a = "function" == typeof LC_AutoInvite.get_layer_html ? LC_AutoInvite.get_layer_html() : "function" == typeof LC_AutoInvite.construct_invite ? LC_AutoInvite.construct_invite() : "", LC_Invite.display_invitation(a, LC_AutoInvite.config.position), !0) : LC_Invite.getEmbeddedLoaded() ? this.embedded_chat_supported() === !1 ? !1 : this.chat_window_maximized() === !0 && null == n ? !0 : this.chat_running() === !0 ? !0 : Minimized.supportRoundedInvitations() || Mobile.isNewMobile() ? (Minimized.renderMobileInvitation(n.avatar_url, n.name, e), NotifyChild.send("invitation_with_agent;" + encodeURIComponent(t) + ";" + encodeURIComponent(e) + ";" + encodeURIComponent(JSON.stringify(n)) + ";0"), !0) : Mobile.isDetected() ? !0 : ("undefined" == typeof t && (t = ""), i = "undefined" == typeof i ? "" : parseInt(i, 10), void(null == n ? (NotifyChild.send("invitation;" + encodeURIComponent(t) + ";" + i + ";" + encodeURIComponent(e)), this.show_full_view()) : (s = "0", NotifyChild.send("invitation_with_agent;" + encodeURIComponent(t) + ";" + encodeURIComponent(e) + ";" + encodeURIComponent(JSON.stringify(n)) + ";" + encodeURIComponent(s)), o && this.show_full_view()))) : (setTimeout(function() {
        r.display_embedded_invitation(e, t, i, n, o)
      }, 500), !1)
    },
